...
const DinhGiaSimTool = ({ faqData }: { faqData: FaqItem[] }) => {
  ...
  return (
    <>
        ...
        <section className="max-w-2xl mx-auto mb-8 animate-fade-in">
          ...
          <div className="bg-card rounded-xl shadow-card border border-border p-5 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href="https://zalo.me/0933356666?text=%F0%9F%91%8B%20Xin%20ch%C3%A0o%2C%20t%C3%B4i%20mu%E1%BB%91n%20%C4%91%C6%B0%E1%BB%A3c%20t%C6%B0%20v%E1%BA%A5n%20v%E1%BB%81%20%C4%91%E1%BB%8Bnh%20gi%C3%A1%20SIM"
                target="_blank"
      ...
      {/* FAQ: dùng FaqAccordion (`<details>`) để câu trả lời LUÔN có trong DOM.
          Radix AccordionContent chỉ render khi mở, nên FAQPage JSON-LD của trang
          này từng khai đủ hỏi–đáp mà HTML thô chỉ có câu hỏi. */}
