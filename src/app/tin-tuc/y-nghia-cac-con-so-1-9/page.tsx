...
export default function TinTucBai3Page() {
  return (
    <>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-body">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-primary mt-8 mb-4">
              Ý nghĩa của các con số khi kết hợp với nhau
            </h2>
            ...
            <ul className="list-none space-y-1 mt-4">
              ...
              <li>+ 7878 =&gt; thất bát, thất bát (ông địa)</li>
              <li>+ 2879 =&gt; mãi phát tài</li>
              <li>+ 19.19.19 =&gt; 1 bước lên trời</li>
              <li>+ 1102 =&gt; Độc nhất vô nhị</li>
              <li>+ 2204 =&gt; Mãi mãi không chết</li>
              <li>+ 6686 =&gt; Lộc lộc phát lộc</li>
              <li>+ 1111 =&gt; Tứ trụ vững chắc</li>
              <li>+ 2626 =&gt; Mãi lộc mãi lộc</li>
              <li>+ 2628 =&gt; hái lộc hai phát</li>
              <li>+ 1368 =&gt; Cả một đời lộc phát</li>
              <li>+ 1515 =&gt; 2 cái rằm</li>
              ...
              <li>+ 52 39 =&gt; tiền tài</li>
              <li>+ 92 79 =&gt; tiền lớn tài lớn</li>
              <li>+ 39 37 =&gt; tài trời</li>
              <li>+ 39 38 =&gt; thần tài thổ địa</li>
              <li>+ 39 39 =&gt; tài lộc</li>
              <li>+ 3333 =&gt; Toàn tài</li>
              ...
              <li>+ 6666 =&gt; Tứ lộc</li>
              <li>+ 3468 =&gt; Tài tử lộc phát</li>
              <li>+ 6578 =&gt; 6 năm thất bát</li>
              <li>+ 6868 =&gt; lộc phát lộc phát (sáu tấm sáu tấm)</li>
              <li>+ 1668 =&gt; Càng ngày càng phát</li>
              <li>+ 8686 =&gt; Phát lộc phát lộc</li>
              <li>+ 7308 =&gt; Thất tài không phát</li>
              <li>+ 0378 =&gt; Phong ba bão táp</li>
              <li>+ 8181 =&gt; Phát 1 phát 1</li>
              <li>+ 7939 =&gt; Thần tài LỚN, Thần tài nhỏ</li>
              <li>+ 1102 =&gt; Độc nhất vô nhị</li>
              <li>+ 1122 =&gt; Một là một, hai là hai</li>
            ...
            <ul className="list-none space-y-1">
              <li>+ 1110 (0111) = chết thảm (3 hương 1 trứng)</li>
              <li>+ 7749 = chết cực thảm</li>
              <li>+ 4953 = chết cực kỳ thê thảm</li>
              <li>+ 5555: Năm năm nằm ngủ (người thực vật)</li>
            </ul>
            ...
            <ul className="list-none space-y-1">
              <li>+ 6062: Sống không sợ ai</li>
              <li>+ 2204: Mãi mãi không chết</li>
              <li>+ 4444: Tứ bất tử</li>
              <li>+ 8648 : trường sinh bất tử</li>
              <li>+ 0404 : không chết không chết</li>
            </ul>
