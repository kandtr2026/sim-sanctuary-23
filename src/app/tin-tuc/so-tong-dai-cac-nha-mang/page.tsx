...
export default function TinTucBai2Page() {
  return (
    <>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="font-semibold text-body mb-2">Số tổng đài Vinaphone 9191</p>
              <p className="text-body mb-4">
              ...
              <p className="font-semibold text-body mb-2">Số tổng đài Vinaphone 9192</p>
              <p className="text-body mb-4">
