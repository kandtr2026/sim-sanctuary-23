  ...
  return (
    <>
      <main className="min-h-screen bg-background">
        ...
        >
          <CategoryHeroArt numerals={["6688", "3399"]} />
        ...
        <div className="container mx-auto space-y-10 px-4 py-8 md:space-y-14 md:py-12">
          ...
          <CategorySimGrid
            ...
            emptyText="Kho tạm hết số khớp yêu cầu này. Quý khách thử đuôi khác như *5500, hoặc gọi 0933.686.666 để đội ngũ tư vấn lọc theo ngân sách."
            matchTags={[TAG]}
          />
