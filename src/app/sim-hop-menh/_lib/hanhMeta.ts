...
export const HANH_META: Record<NguHanh, HanhMeta> = {
  Kim: {
    ...
    description:
      "Sim hợp mệnh Kim Mobifone: ưu tiên chữ số 2, 5, 8 (Thổ sinh Kim) và 6, 7 đồng hành, hạn chế số 9. Số thật kèm giá niêm yết, đăng ký thông tin chính chủ.",
    intro:
  ...
  Mộc: {
    ...
    description:
      "Sim hợp mệnh Mộc Mobifone: ưu tiên chữ số 0, 1 (Thủy sinh Mộc) và 3, 4 đồng hành, hạn chế 6, 7. Số thật kèm giá niêm yết, đăng ký thông tin chính chủ.",
    intro:
  ...
  Thủy: {
    ...
    description:
      "Sim hợp mệnh Thủy Mobifone: ưu tiên chữ số 6, 7 (Kim sinh Thủy) và 0, 1 đồng hành, hạn chế 2, 5, 8. Số thật kèm giá niêm yết, đăng ký thông tin chính chủ.",
    intro:
  ...
  Hỏa: {
    ...
    description:
      "Sim hợp mệnh Hỏa Mobifone: ưu tiên chữ số 3, 4 (Mộc sinh Hỏa) và số 9 đồng hành, hạn chế 0, 1. Số thật kèm giá niêm yết, đăng ký thông tin chính chủ.",
    intro:
  ...
  Thổ: {
    ...
    description:
      "Sim hợp mệnh Thổ Mobifone: ưu tiên số 9 (Hỏa sinh Thổ) và 2, 5, 8 đồng hành, hạn chế 3, 4. Số thật kèm giá niêm yết công khai, đăng ký thông tin chính chủ.",
    intro:
