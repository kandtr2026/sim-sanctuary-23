...
export const ROADMAP: RoadmapPhase[] = [
  {
    ...
    tasks: [
      ...
      { id: "A3", title: "Nối GA4 → Google Ads + conversion action Zalo/gọi", status: "done", priority: "P0", kpi: "Ads nhận chuyển đổi 'lead' → đấu thầu theo chuyển đổi", next: "Xong qua GA4-import: generate_lead (key event GA4) đã import làm conversion trong Google Ads; generate_lead verified bắn đúng về GA4 (31/08, method+utm đủ). QUAN TRỌNG: KHÔNG set NEXT_PUBLIC_GADS_AW_ID/LABEL — sẽ khiến Ads đếm chuyển đổi 2 lần. Kiểm định kỳ: Google Ads → Chuyển đổi → trạng thái 'Đang ghi nhận'.", updated: "2026-08-31" },
      { id: "A4", title: "Kích hoạt Facebook Pixel (set NEXT_PUBLIC_FB_PIXEL_ID)", status: "done", priority: "P1", kpi: "Pixel Helper xanh; có event Lead khi bấm Zalo", next: "LIVE 31/08: pixel 2029503737688978 (dataset 'Chonsomobifone Web'), env NEXT_PUBLIC_FB_PIXEL_ID set Production. Verify trình duyệt: init + PageView khi load, Lead khi bấm Zalo. Còn lại: dựng tệp remarketing khi chạy FB Ads.", updated: "2026-08-31" },
      { id: "A5", title: "Search Console: verify + nộp sitemap + đọc query thật", status: "doing", priority: "P1", kpi: "100+ URL indexed; có bảng query thay suy đoán từ khoá", next: "ĐÃ NỐI GSC (31/08): env GSC_SIM_CLIENT_EMAIL + GSC_SIM_PRIVATE_KEY đã set, /api/admin/seo-rank chạy thật 0 lỗi (property sc-domain:chonsomobifone.com, 116 từ khoá). Bảng /admin/seo tự điền cột thứ hạng khi GSC tích luỹ data (~2-3 ngày nữa kể từ 31/08).", updated: "2026-08-31" },
